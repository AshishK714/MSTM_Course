...
<p>Column granularity is how finely a value is recorded. Most things vary continuously, and we record them at separated points because that is cheaper. How finely you record decides which kind of variable you have, and the level depends on how you plan to use it.</p>
...
<p>In the FPF file, salary is recorded to the currency unit, attendance to the whole percentage point, and prior experience as one of two bands, so eighteen and thirty-four months are alike.</p>
