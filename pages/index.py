...
PARTS = [
    ...
    ('part3.html', 'Part 3', 'What a column measures',
     ...
     ['Form: a recorded thing whose form somebody chose', 'Structural blanks are not missing data', 'Denominators',
      'What can be added up', 'The operationalization chain', 'What a measure records and what it leaves out',
