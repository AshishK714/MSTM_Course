...
<p>Questions 1 and 2 are the ones that cannot be repaired later. If the rows are the wrong people, or at the wrong grain, no amount of care with questions 3 to 5 recovers anything. A perfectly defined salary column, measured on a group that excludes everyone who left early, still answers a question about leavers with silence. That is why Part 2 comes early, and why a question that looks like it is about a number is so often answered by looking at the rows instead.</p>
